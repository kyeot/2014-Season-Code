...
<Project Type="Project" LVVersion="13008000">
	<Property Name="varPersistentID:{15499469-72E9-4168-A080-F9ECAAEC5F3E}" Type="Ref">/RT CompactRIO Target/Team Code/Periodic Tasks.vi/Timer On Delay/error in</Property>
	<Property Name="varPersistentID:{1B27C0E0-87BA-4402-9332-8EAB080EEDC7}" Type="Ref">/RT CompactRIO Target/Team Code/Periodic Tasks.vi/Timer On Delay/error out</Property>
	<Property Name="varPersistentID:{54BD7947-4354-47C5-905A-3D8ABAC8AD16}" Type="Ref">/RT CompactRIO Target/Team Code/Periodic Tasks.vi/Timer On Delay/input</Property>
	<Property Name="varPersistentID:{A470C174-79BF-49C8-AFA9-F8D828870506}" Type="Ref">/RT CompactRIO Target/Team Code/Periodic Tasks.vi/Timer On Delay/preset time (ms)</Property>
	<Property Name="varPersistentID:{E255580C-C85F-49AD-8DF8-DC6407DBAABC}" Type="Ref">/RT CompactRIO Target/Team Code/Periodic Tasks.vi/Timer On Delay/output</Property>
	<Property Name="varPersistentID:{F1D5647E-2581-45C8-824E-BF0338959E7C}" Type="Ref">/RT CompactRIO Target/Team Code/Periodic Tasks.vi/Timer On Delay/elapsed time (ms)</Property>
...
DirectoryIndex index.htm
		...
		<Item Name="Custom VIs" Type="Folder">
			...
			<Item Name="Map Function.vi" Type="VI" URL="../Custom Utils/Map Function.vi"/>
			...
			<Item Name="Falling Edge Detect.vi" Type="VI" URL="../Custom Utils/Falling Edge Detect.vi"/>
			<Item Name="Rising Edge Detect.vi" Type="VI" URL="../Custom Utils/Rising Edge Detect.vi"/>
